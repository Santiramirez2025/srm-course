    ...
    <section className="relative max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16 lg:py-24">
      ...
      <div className="text-center">
        ...
        {hasStarted && !isCompleted && (
          <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 text-amber-700 rounded-full text-xs sm:text-sm font-semibold mb-3 sm:mb-4 animate-fadeIn shadow-sm">
        ...
        {isCompleted && (
          <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 text-green-700 rounded-full text-xs sm:text-sm font-semibold mb-3 sm:mb-4 animate-fadeIn shadow-sm">
        ...
        {/* Botón principal responsive y touch-friendly */}
        ...
        {stats && (
          <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 pt-8 sm:pt-10 border-t border-gray-200 animate-fadeInUp animation-delay-500 max-w-4xl mx-auto px-4 sm:px-0">
            {stats.totalModules && (
              <div className="group">
                <div className="flex items-center gap-3 sm:gap-4 bg-white rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-md hover:shadow-xl border border-gray-100 transition-all duration-300 hover:-translate-y-1">
